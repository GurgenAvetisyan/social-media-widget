...
const footerIcons = [
  ...
  { id: uniqueId(), title: "2.7K", icon: <RepeatIcon /> },
  { id: uniqueId(), title: "22K", icon: <HeartIcon /> },
  { id: uniqueId(), title: "22K", icon: <EqualizerIcon /> },
];

const TwitterPreviewCard = ({ styles }) => {
  return (
    <div className={styles.previewCardWrap}>
      <div className={styles.centeredWithGap}>
        <img src={avatar} alt="avatar" className={styles.avatar} />
        <div>
          <div className={styles.twitterHeaderRightBox}>
            <div className={styles.name}>John Doe</div>
            <div className={styles.centeredWithGap}>
              <div className={styles.secondaryText}>@johndoe</div>
              <div className={styles.separatorPoint} />
              <div className={styles.createdDate}>Oct 31</div>
            </div>
          </div>

          <div className={styles.secondaryText}>Lorem ipsum</div>
        </div>
      </div>
